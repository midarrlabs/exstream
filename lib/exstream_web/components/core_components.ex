defmodule ExstreamWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ExstreamWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ExstreamWeb.Gettext, "errors", msg, opts)
    end
  end
